...
const educationalClustersData: EducationalCluster[] = [
  {
    clusterName: 'מקבץ בית יעקב מרגלית',
    cityName: 'ירושלים',
    totalInstitutions: 52,
    totalInjured: 51,
    severeInjuries: 8,
    deaths: 1,
  },
  {
    clusterName: 'מקבץ ויזניץ',
    cityName: 'בני ברק',
  ...
  {
    clusterName: 'מקבץ ישיבת בית מרדכי',
    cityName: 'ירושלים',
    totalInstitutions: 31,
    totalInjured: 44,
    severeInjuries: 5,
    deaths: 2,
  },
  {
    clusterName: 'מקבץ בית יעקב דרכי רחל',
    cityName: 'ירושלים',
  ...
  {
    clusterName: 'מקבץ ישיבת בית מנחם',
    cityName: 'בני ברק',
    totalInstitutions: 29,
    totalInjured: 62,
    severeInjuries: 8,
    deaths: 0,
  },
  {
    clusterName: 'מקבץ בי"ס סולם',
    cityName: 'בני ברק',
  ...
  {
    clusterName: 'מקבץ בי סמינר רמות שמסיאב',
    cityName: 'ירושלים',
  ...
  {
    clusterName: 'מקבץ ישיבת מאור ושמש ביתר',
    cityName: 'ביתר עילית',
    totalInstitutions: 35,
    totalInjured: 12,
    severeInjuries: 9,
    deaths: 1,
  },
  {
    clusterName: 'מקבץ שובו תל אביב',
        ...
        <table className="w-full min-w-[800px]">
          ...
          <tbody>
            {educationalClustersData.map((cluster, index) => (
              <tr
                key={`${cluster.clusterName}-${cluster.cityName}-${index}`}
