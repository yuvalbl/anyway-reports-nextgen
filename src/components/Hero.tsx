...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="relative w-full h-[873px] flex items-center justify-center text-center">
      ...
      >
        <div
          className="absolute inset-0 bg-gradient-to-b from-[rgba(250,254,255,0)] via-[rgba(250,254,255,0)] to-[rgba(232,247,252,1)]"
          style={{
            background:
              'linear-gradient(180deg, rgba(250, 254, 255, 0) 14%, rgba(232, 247, 252, 1) 82%)',
          }}
        ></div>
      </div>
